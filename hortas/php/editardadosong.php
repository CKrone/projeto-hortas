			...
			<article class="card-body mx-auto" style="max-width: 400px;">
				...
				<form method="POST" action="processa_edit_dadosong.php">
					...
					<div class="form-group input-group">
						...
						<input name="telefone" class="form-control" value="<?php echo $row_ong['telefone']; ?>" placeholder="Telefone" type="text" onkeypress="return ApenasNumeros(event,this);" required>
					</div>
					<div class="form-group input-group">
						<div class="input-group-prepend">
							<span class="input-group-text"> <i class="fa fa-phone"></i> </span>
						</div>
						<input name="celular" class="form-control" value="<?php echo $row_ong['celular']; ?>" placeholder="Celular" type="text" onkeypress="return ApenasNumeros(event,this);" required>
					</div>
