...
<body>
	...
	<article class="card-body mx-auto" style="max-width: 400px;">
		...
		<form method="POST" action="informar.php">
			<div><h6>Informe o nome do produto</h6></div>
			...
			<div><h6>Informe a data de colheita do produto</h6></div>
			<div class="form-group input-group">
				<div class="input-group-prepend">
			...
			<div><h6>Informe a data de vencimento do produto</h6></div>
			<div class="form-group input-group">
				<div class="input-group-prepend">
			...
			<div><h6>Informe a quantidade de produtos colhidos</h6></div>
			<div class="form-group input-group">
				<div class="input-group-prepend">
